...
<div class="modal fade" id="modalActualizarCitaAD" tabindex="-1" aria-labelledby="modalActualizarLabel" aria-hidden="true">
                ...
                <form id="nueva-citaAD">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8 col-lg-8">
                            <input type="date" id="fechaModalAD" class="form-control" min="<?php echo date('Y-m-d'); ?>" value="">
                        </div>
                    </div>
                    ...
                    <div id="horas" class="form-group row">
                        ...
                        <div class="col-sm-8 col-lg-8">
                            <select id="horaIDModalAD" class="form-select">
