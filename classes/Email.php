...
class Email
{
    ...
    //constructor donde pasaremos los datos del usuario
    ...
    public function enviarConfirmacion()
    {
        ...
        $contenido = '<html>';
        $contenido .= "<p><strong>Hola " . $this->nombre .  "</strong> Has Registrado Correctamente tu cuenta en AmorPorTi; pero es necesario confirmarla</p>";
